...
<div class= "menuMapa" id="menuC">
    <div class='txtM'>
        ...
        <div class="contet_M">
            <input type="radio" name="region" class='ali' value="st" onclick="mapa(8)" required>Seleccionar todo<br>
            <input type="radio" name="region" class='ali' value="mag" id="sub1" onclick="mapa(2)" required>Magdalena Caldense<br>
            <input type="radio" name="region" class='ali' value="alor" id="sub2" onclick="mapa(3)" required>Alto oriente<br>
            <input type="radio" name="region" class='ali' value="nor" id="sub3" onclick="mapa(4)" required>Norte<br>
            <input type="radio" name="region" class='ali' value="alocc" id="sub4" onclick="mapa(5)" required>Alto occidente<br>
            <input type="radio" name="region" class='ali' value="bjocc" id="sub5" onclick="mapa(6)" required>Bajo occidente<br>
            <input type="radio" name="region" class='ali' value="cs" id="sub6" onclick="mapa(7)" required>Centro sur
        </div>
        <div class="subt_M">
            Aspecto a graficar
        </div>
        <div class="contet_M">
            ...
            <div id="algode" class="opcion_gr">
                ...
                <div class="herm"><input type="radio" name="op_1" value="p6"  id='op_1_6' class='ali' required><label for="op_1_6" class='no_mar' >Afiliación en salud</label></div>
